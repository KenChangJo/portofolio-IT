...
class Player(GameSprite):
    ...
    def update(self):
        # Horizontal movement
        if 0 <= self.rect.x + self.x_speed <= win_width - 80:
        ...
        # Vertical movement
        if 0 <= self.rect.y + self.y_speed <= win_height - 80:
...
monster2 = Enemy('cyborg.png', win_width - 120, 230, 80, 80, 5)
monsters = sprite.Group(monster, monster2)
